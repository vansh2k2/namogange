...
const Page2 = () => {
   ...
   const columns = [
  { label: "Company Name", accessor: "company.name", width: "w-52" },
  { label: "Company Email", accessor: "company.email", width: "w-52" },
  { label: "Contact Person", accessor: "contact.person", width: "w-40" },
  { label: "Phone", accessor: "contact.phone", width: "w-40" },
  { label: "Category", accessor: "category.main", width: "w-36" },
  { label: "Sub Category", accessor: "category.sub", width: "w-40" },
  { label: "Business Type", accessor: "Bussiness.type", width: "w-44" },
  { label: "City", accessor: "location.city", width: "w-32" },
  { label: "State", accessor: "location.state", width: "w-32" },
  { label: "Pincode", accessor: "location.pincode", width: "w-28" },
  { label: "Source Type", accessor: "source.type", width: "w-36" },
  { label: "Added By", accessor: "source.addedBy", width: "w-32" },
